...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('monitoring_points_notification_settings', function (Blueprint $table) {
            ...
            $table->string('monitoring_point_id', 36);
            ...
            $table->foreign('notification_setting_id','notifications_setting_id')->references('id')->on('notifications_settings')->onDelete('cascade');
            $table->timestamps();
            $table->softDeletes();
