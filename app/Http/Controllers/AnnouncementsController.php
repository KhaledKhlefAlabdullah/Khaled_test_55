 ...
 */
    ...
    {
        // Get the announcements by id and check if exists
        try {
            ...
            $data->delete();
            return api_response(
                message: __('deleted-announcements-successfully')
            );

        } catch (NotFoundResourceException $e) {

            return api_response(
                message: __('error-deleted-announcements'), code: 402, errors: [$e->getMessage()]
            );
