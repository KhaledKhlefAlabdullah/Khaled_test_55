...
class StakeholderSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('stakeholders')->insert([
            ...
            'representative_government_agency' => 'Department of Industry',
            'tent_company_state' => 'operating',
